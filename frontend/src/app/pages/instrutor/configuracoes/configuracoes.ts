...
export class Configuracoes implements OnInit {
  ...
  @ViewChild('formLocais')
  formLocais!: FormLocaisAtendimento;
  ...
  montarFotoUsuario(usuario: any): void {
  ...
  carregarUsuarioLogado(): void {
    ...
    if (usuarioStorage) {
      ...
      try {
        ...
        console.error(
          'Erro ao converter usuário do localStorage:',
          error
        );
    ...
    this.montarFotoUsuario(this.usuario);
    ...
    this.http
      ...
      .subscribe({
        ...
        next: (instrutor) => {
          ...
          this.montarFotoUsuario(instrutor);
        ...
        error: (err) => {
          ...
          alert(
            'Erro ao buscar dados do instrutor.'
          );
        }
      });
  }
  ...
  deletarVeiculo(
    ...
    this.http
      .delete<any>(
        `${this.apiUrl}/${this.usuarioId}/veiculos/${veiculo.id}`
      )
      .subscribe({
  ...
  salvarListaVeiculos(
    ...
    this.http
      .put<any>(
        `${this.apiUrl}/${this.usuarioId}/veiculos`,
        lista
      )
      .subscribe({
  ...
  apagarMinhaConta(): void {
    ...
    this.http
      .delete(
        `http://localhost:8081/api/usuarios/${this.usuarioId}`
      )
      .subscribe({
